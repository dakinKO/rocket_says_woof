...
from classes import UserInfo, Levels, Message, SquareGrid
...
tower_menu = pg.Rect((48 * TILE_SIZE, 0), (TILE_SIZE * 10, SCREEN_HEIGHT))
...
def show_user_info(surface, user_info):
    ...
    coins = Message(surface, (5, 60), ('Coins: ' + str(user_info.coins)), bg_color=LIGHT_BLUE)
    # Blit the info
    wave.blit()
    lives.blit()
    coins.blit()
